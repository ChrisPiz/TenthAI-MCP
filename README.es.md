...
[Demo — oferta de trabajo](https://chrispiz.github.io/Henge-MCP/demo-job.html) · [Demo — portafolio IA](https://chrispiz.github.io/Henge-MCP/demo.es.html) · [Paper](WHITEPAPER.md) ·
